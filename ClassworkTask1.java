...
public class ClassworkTask1 {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < myCollect.length; i++){//длинна массива = 8
			if (max < myCollect[i]) {
				max = myCollect[i];
				maxNumber = i;//i - это индекс, переменная maxNumbe принимает значение индекса максимального числа
				}
		} 
	    ...
	    for(int i = 0; i < myCollect.length; i++){
			if (min > myCollect[i]) {
				min = myCollect[i];
				minNumber = i;//i - это индекс, переменная minNumbe принимает значение индекса минимального числа
				}
		} 
